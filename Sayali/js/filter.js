...
$('select.filter').on('change', function () {
  ...
  if (prodVal == "0" && platVal == "0") {
    ...
    if (prodVal == "0" && platVal != "0") {
      $('.item[ data-filter-painting="' + platVal + '"]').removeClass('hidden').addClass('visible');
    } else if (prodVal != "0" && platVal == "0") {
      $('.item[data-filter-product="' + prodVal + '"]').removeClass('hidden').addClass('visible');
    } else {
      $('.item[ data-filter-painting="' + platVal + '"][data-filter-product="' + prodVal + '"]').removeClass('hidden').addClass('visible');
    }
